...
;; MF: you need purpose statements for all judgments,
;; and it is easy to write purpose statements here
...
;; MF: but what is (r ...) -- context explanation
(define-judgment-form dadl
